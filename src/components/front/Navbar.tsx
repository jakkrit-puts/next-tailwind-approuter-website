                  ...
                  <Link
                    className={
                      currentPathName === "/home"
                        ? "text-blue-400 bg-slate-100 rounded-lg p-2"
                        : "p-2 flex items-center text-sm  text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:bg-neutral-700 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                    }
                    href="/home"
                    aria-current="page"
                  >
